...
<div class="col-xs-6 lg_left">
    <div class="col-xs-12">
        <div class="col-xs-12  lg_lf_top">
            <h2><?php echo L('_WELCOME_TO_');?> <?php if(($login_type) == "login"): ?><a href="http://<?php echo $_SERVER['HTTP_HOST'];?>/love" title="L('_ENTER_INDEX_')"><?php echo modC('WEB_SITE_NAME',L('_OPEN_SNS_'),'Config');?></a><?php else: echo modC('WEB_SITE_NAME',L('_OPEN_SNS_'),'Config'); endif; ?> ！</h2>
        </div>
        <div class="clearfix"></div>
        <form action="/love/index.php?s=/ucenter/member/login.html" method="post" class="lg_lf_form ">
            <div class="row">
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-block btn-primary"><?php echo L('_LOGIN_SPACE_');?></button>
            </div>
...
<div class="col-xs-6">
    ...
    <div class="" style="margin: 21px 0 16px 40px;">
        ...
        <h2><?php echo L('_ACCOUNT_LOST_'); echo L('_QUESTION_');?></h2>
