...
<!--顶部导航之后的钩子，调用公告等 end-->
    ...
    <script type="text/javascript" src="/love/Public/js/ajaxfileupload.js"></script>
    <link href="/love/Application/Weibo/Static/css/weibo.css" type="text/css" rel="stylesheet"/>
    <!--微博内容列表部分-->
            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <a href="javascript:" onclick="insertFace($(this))">
                        <img class="weibo_type_icon" src="/love/Application/Core/Static/images/bq.png"/>
                    </a>
                    <?php if(modC('CAN_IMAGE',1)): ?><a href="javascript:" id="insert_image" onclick="insert_image.insertImage(this)">
                        <img class="weibo_type_icon" src="/love/Application/Weibo/Static/images/image.png"/>
                    </a><?php endif; ?>
                    <?php if(modC('CAN_TOPIC',1)): ?><a href="javascript:" onclick="insert_topic.InsertTopic(this)">
                        <img class="weibo_type_icon" src="/love/Application/Weibo/Static/images/topic.png"/>
                    </a><?php endif; ?>
    ...
    <script type="text/javascript" charset="utf-8" src="/love/Public/js/ext/webuploader/js/webuploader.js"></script>
    <link href="/love/Public/js/ext/webuploader/css/webuploader.css" type="text/css" rel="stylesheet"><?php endif; ?>
...
<?php if(empty($lastId) == false): ?><script>
        ...
        >
        <p id="load_more_text"><img style="margin-top:80px" src="/love/Application/Weibo/Static/images/loading-new.gif"/></p>
    </div>
                ...
                <div>
                    <div class="top_self">
                        <?php if($self['cover_id']): ?><img class="cover uc_top_img_bg_weibo" src="<?php echo ($self['cover_path']); ?>">
                            <?php else: ?>
                            <img class="cover uc_top_img_bg_weibo" src="/love/Application/Core/Static/images/bg.jpg"><?php endif; ?>
                        <?php if(is_login() && $self['uid'] == is_login()): ?><div class="change_cover"><a data-type="ajax" data-url="<?php echo U('Ucenter/Public/changeCover');?>"
                                    ...
                                    class="img-responsive" src="/love/Application/Core/Static/images/fractional.png" style="width: 25px;"></a>
                            </div><?php endif; ?>
                    </div>
                </div>
...
<script src="/love/Public/js/ext/lazyload/lazyload.js"></script>
    ...
    <script src="/love/Application/Weibo/Static/js/weibo.js"></script>
    <script>
    ...
    <link rel="stylesheet" href="/love/Application/Weibo/Static/css/photoswipe.css">
    <link rel="stylesheet" href="/love/Application/Weibo/Static/css/default-skin/default-skin.css">
    <script src="/love/Application/Weibo/Static/js/photoswipe.min.js"></script>
    <script src="/love/Application/Weibo/Static/js/photoswipe-ui-default.min.js"></script>
