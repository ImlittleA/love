...
<div class="clearfix">
    ...
    <div class="col-xs-10">
        ...
        <div class="row common_block_title">
            <?php echo L('_POST_LIST_');?>
            <div class="pull-right text-right" style="margin-right: 15px">
                <div class="btn-group forum_order">
                    <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown">
                        <?php if(($order) == "0"): echo L('_REPLY_TIME_'); else: echo L('_DELIVER_TIME_'); endif; ?> <span class="caret"></span>
                    </button>
                    <ul class="dropdown-menu text-left" role="menu">
                        <li><a href="<?php echo U('forum',array('id'=>$forum_id,'order'=>'ctime'));?>"><?php echo L('_DELIVER_TIME_');?></a></li>
                        <li><a href="<?php echo U('forum',array('id'=>$forum_id,'order'=>'reply'));?>"><?php echo L('_REPLY_TIME_');?></a></li>
                    </ul>
                </div>
            </div>
        </div>
