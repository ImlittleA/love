...
<!--顶部导航之后的钩子，调用公告等 end-->
    ...
    <div id="body-container" class="container  common-block">
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="fourm-top common_block_border"
                        ...
                        <h4>
                            <?php if($isEdit): echo L('_POST_EDIT_');?>
                                <?php else: ?>
                                <?php echo L('_POST_PUBLISH_'); endif; ?>
                        </h4>
                        <hr/>
                        <section id="contents">
                            <form action="<?php echo U('Forum/Index/doEdit');?>" method="post" id="edit-article-form" style="width: 665px;">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-9">
                                        <p>
                                            <input id="title" type="text" name="title" placeholder="<?php echo L('_TITLE_');?>"
                    ...
                    <span id="submit-content">
                        <?php if($isEdit): echo L('_POST_EDIT_');?> Ctrl+Enter
                            <?php else: ?>
                            <?php echo L('_POST_PUBLISH_');?> Ctrl+Enter<?php endif; ?>
                    </span>
                                    </button>
                                ...
                                <p>
                                    ...
                                    <?php if(($hasWeibo) == "1"): ?><label>
                                            <input type="checkbox" name="sendWeibo" value="1" checked> <?php echo L('_SYN_TO_TWITTER_');?>
                                        </label><?php endif; ?>
        ...
        <div class="col-xs-4">
                ...
                <div>
                    <h1><?php echo L('_POST_PUBLISH_KNOWLEDGE_');?></h1>

                    <p>
                        <?php echo L('_POST_PUBLISH_KNOWLEDGE_CONTENT_');?>
                    </p>

                </div>
            <?php echo W('Common/Adv/render',array(array('name'=>'below_tip','type'=>1,'width'=>'355px','height'=>'150px','margin'=>'0 0 10px 0','title'=>'发帖须知下方')));?>
...
<script src="/love/Public/js/ext/lazyload/lazyload.js"></script>
    ...
    <script type="text/javascript" src="/love/Public/Core/js/ext/atwho/atwho.js"></script>
    <link type="text/css" rel="stylesheet" href="/love/Public/Core/js/ext/atwho//atwho.css"/>
    <script>
        //点击编辑或发表按钮之后
        $(function () {
            ...
            function showSubmitError(message) {
                ...
                var text = '';
                if (isEdit) {
                    text = "<?php echo L('_POST_EDIT_');?>";
                } else {
                    text ="<?php echo L('_POST_PUBLISH_');?>";
                }
                $('#submit-content').text(text);
                toast.error(message, "<?php echo L('_ERROR_');?>");
            }

            function showSubmitSuccess(message, url) {
                toast.success(message, "<?php echo L('_TIP_SWEET_');?>");
                setTimeout(function () {
                    location.href = url;
                }, 1500);
            }
            ...
            function showSubmitting() {
                ...
                $('#submit-content').text("<?php echo L('_SUBMITTING_');?>");
            }
        })
    </script>
