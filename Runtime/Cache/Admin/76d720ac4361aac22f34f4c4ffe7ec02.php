...
<div class="panel-main" style="float:left;">
	...
	<div class="main-title">
		<h2><?php echo L("_HOOK_LIST_");?></h2>
	</div>
	<div class="with-padding">
		<?php if (IS_ROOT): ?>
			<a class="btn" href="<?php echo U('addhook');?>"><?php echo L("_NEW_GROWTH_WITH_SPACE_");?></a>
		<?php endif ?>
	</div>
		...
		<table class="table table-bordered table-striped ">
			<thead>
				<tr>
					...
					<th><?php echo L("_DESCRIPTION_");?></th>
			...
			<tbody>
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
						...
						<td>
							<a title=<?php echo L("_EDIT_WITH_DOUBLE_");?> href="<?php echo U('edithook?id='.$vo['id']);?>"><?php echo L("_EDIT_");?></a>
							<a class="confirm ajax-get" title=<?php echo L("_DELETE_WITH_DOUBLE_");?> href="<?php echo U('delhook?id='.$vo['id']);?>"><?php echo L("_DELETE_");?></a>
						</td>
